...
class SwitchCell: UITableViewCell {
    ...
    private var setting: LearnSettings.Question?
    ...
    func configure(setting: LearnSettings.Question, for toggle: LearnSettings.Question) {
        self.setting = toggle
        titleLabel.text = toggle.name
        switch setting {
        case .word:
            if self.setting == .word {
    ...
    @objc func valueChanged(sender: UISwitch) {
        delegate?.switchChanged(sender: sender, setting: setting)
    }
